...
<body>
                ...
                $query="select * from scientist SC,satellite S,organisation O,rocket R ,conditions C,follows F where SC.SID=S.SID and S.ORGID=O.ORGID and S.RID=R.RID and F.CONDID=C.CONDID and S.SATID=F.SATID and SATNAME like '$name'";                
